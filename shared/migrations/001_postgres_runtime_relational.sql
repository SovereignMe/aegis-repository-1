...
-- Repository, Intake, Controls, Audits, Deadlines, Contacts, Settings and Integration.
...
CREATE INDEX IF NOT EXISTS idx_timers_started_at ON timers(started_at DESC);
